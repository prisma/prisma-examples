...
func (client *Client) Post(params PostWhereUniqueInput) *PostExec {
	ret := client.Client.GetOne(
		...
		"post",
		[]string{"id", "wasCreated", "wasUpdated", "title", "content", "published"})
...
const (
	...
	PostOrderByInputWasCreatedAsc  PostOrderByInput = "wasCreated_ASC"
	PostOrderByInputWasCreatedDesc PostOrderByInput = "wasCreated_DESC"
	PostOrderByInputWasUpdatedAsc  PostOrderByInput = "wasUpdated_ASC"
	PostOrderByInputWasUpdatedDesc PostOrderByInput = "wasUpdated_DESC"
...
type CommentCreateInput struct {
	...
	WrittenBy UserCreateOneInput `json:"writtenBy"`
}
...
type PostScalarWhereInput struct {
	...
	IDEndsWith           *string                `json:"id_ends_with,omitempty"`
	IDNotEndsWith        *string                `json:"id_not_ends_with,omitempty"`
	WasCreated           *string                `json:"wasCreated,omitempty"`
	WasCreatedNot        *string                `json:"wasCreated_not,omitempty"`
	WasCreatedIn         []string               `json:"wasCreated_in,omitempty"`
	WasCreatedNotIn      []string               `json:"wasCreated_not_in,omitempty"`
	WasCreatedLt         *string                `json:"wasCreated_lt,omitempty"`
	WasCreatedLte        *string                `json:"wasCreated_lte,omitempty"`
	WasCreatedGt         *string                `json:"wasCreated_gt,omitempty"`
	WasCreatedGte        *string                `json:"wasCreated_gte,omitempty"`
	WasUpdated           *string                `json:"wasUpdated,omitempty"`
	WasUpdatedNot        *string                `json:"wasUpdated_not,omitempty"`
	WasUpdatedIn         []string               `json:"wasUpdated_in,omitempty"`
	WasUpdatedNotIn      []string               `json:"wasUpdated_not_in,omitempty"`
	WasUpdatedLt         *string                `json:"wasUpdated_lt,omitempty"`
	WasUpdatedLte        *string                `json:"wasUpdated_lte,omitempty"`
	WasUpdatedGt         *string                `json:"wasUpdated_gt,omitempty"`
	WasUpdatedGte        *string                `json:"wasUpdated_gte,omitempty"`
	Title                *string                `json:"title,omitempty"`
...
func (instance *PostExec) Comments() *CommentExec {
	ret := instance.exec.Client.GetOne(
		instance.exec,
		nil,
		[2]string{"", "Comment"},
...
type Post struct {
	ID         string  `json:"id"`
	WasCreated string  `json:"wasCreated"`
	WasUpdated string  `json:"wasUpdated"`
	Title      string  `json:"title"`
	Content    *string `json:"content,omitempty"`
