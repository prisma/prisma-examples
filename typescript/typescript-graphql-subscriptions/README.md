...
This example demonstrates how to use GraphQL Subscriptions with a **GraphQL server with TypeScript** based on Prisma & [graphql-yoga](https://github.com/prisma/graphql-yoga).
