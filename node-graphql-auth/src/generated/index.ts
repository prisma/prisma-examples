...
export interface Prisma {
  ...
  */
    ...
    deleteUser: <T = User>(where: UserWhereUniqueInput, fragment?: string | object) => T;
...
export interface Subscription {
    user: <T = UserSubscriptionPayload>(where?: UserSubscriptionWhereInput, fragment?: string | object) => T;
}
...
export interface DelegateSubscription {
    user: <T = Promise<Partial<UserSubscriptionPayloadNode | null>>>(where?: UserSubscriptionWhereInput, fragment?: string | object) => T
}
...
export interface UserEdge extends Promise<UserEdgeNode | AsyncIterator<UserEdgeNode>> {
        node: <T = User>() => T
...
export interface UserPreviousValues extends Promise<UserPreviousValuesNode | AsyncIterator<UserPreviousValuesNode>> {
...
export interface AggregateUser extends Promise<AggregateUserNode | AsyncIterator<AggregateUserNode>> {
        count: () => Promise<Int>
      }
...
export interface User extends Promise<UserNode | AsyncIterator<UserNode>> {
        id: () => Promise<ID_Output>
  createdAt: () => Promise<DateTimeOutput>
  updatedAt: () => Promise<DateTimeOutput>
  name: () => Promise<String>
...
export interface UserSubscriptionPayload extends Promise<UserSubscriptionPayloadNode | AsyncIterator<UserSubscriptionPayloadNode>> {
...
export interface UserConnection extends Promise<UserConnectionNode | AsyncIterator<UserConnectionNode>> {
