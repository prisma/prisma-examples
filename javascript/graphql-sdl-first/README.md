...
The schema that specifies the API operations of your GraphQL server is defined in [`./prisma/schema.graphql`](./schema.graphql). Below are a number of operations that you can send to the API using the GraphQL Playground.
