...
export type Query = {
  ...
  note: (
    args: { where: NoteWhereUniqueInput },
    info?: GraphQLResolveInfo | string,
  ) => Promise<Note | null>
  usersConnection: (
    args: {
...
export type Subscription = {
  ...
  note: (
    args: { where?: NoteSubscriptionWhereInput },
    infoOrQuery?: GraphQLResolveInfo | string,
  ) => Promise<AsyncIterator<NoteSubscriptionPayload>>
}
...
export class Prisma extends BasePrisma {
  ...
  exists = {
    ...
    Note: (where: NoteWhereInput): Promise<boolean> =>
      super.existsDelegate('query', 'notes', { where }, {}, '{ id }'),
  }

  query: Query = {
    users: (args, info): Promise<User[]> =>
      super.delegate('query', 'users', args, {}, info),
    notes: (args, info): Promise<Note[]> =>
      super.delegate('query', 'notes', args, {}, info),
    user: (args, info): Promise<User | null> =>
      super.delegate('query', 'user', args, {}, info),
    note: (args, info): Promise<Note | null> =>
      super.delegate('query', 'note', args, {}, info),
    usersConnection: (args, info): Promise<UserConnection> =>
      super.delegate('query', 'usersConnection', args, {}, info),
    notesConnection: (args, info): Promise<NoteConnection> =>
      super.delegate('query', 'notesConnection', args, {}, info),
  ...
  mutation: Mutation = {
    ...
    createNote: (args, info): Promise<Note> =>
      super.delegate('mutation', 'createNote', args, {}, info),
    updateUser: (args, info): Promise<User | null> =>
      super.delegate('mutation', 'updateUser', args, {}, info),
    updateNote: (args, info): Promise<Note | null> =>
      super.delegate('mutation', 'updateNote', args, {}, info),
    deleteUser: (args, info): Promise<User | null> =>
      super.delegate('mutation', 'deleteUser', args, {}, info),
    deleteNote: (args, info): Promise<Note | null> =>
      super.delegate('mutation', 'deleteNote', args, {}, info),
    upsertUser: (args, info): Promise<User> =>
      super.delegate('mutation', 'upsertUser', args, {}, info),
    upsertNote: (args, info): Promise<Note> =>
      super.delegate('mutation', 'upsertNote', args, {}, info),
    updateManyUsers: (args, info): Promise<BatchPayload> =>
      super.delegate('mutation', 'updateManyUsers', args, {}, info),
    updateManyNotes: (args, info): Promise<BatchPayload> =>
      super.delegate('mutation', 'updateManyNotes', args, {}, info),
    deleteManyUsers: (args, info): Promise<BatchPayload> =>
      super.delegate('mutation', 'deleteManyUsers', args, {}, info),
    deleteManyNotes: (args, info): Promise<BatchPayload> =>
      super.delegate('mutation', 'deleteManyNotes', args, {}, info),
  }
  ...
  subscription: Subscription = {
    ...
    note: (
      ...
      super.delegateSubscription('note', args, {}, infoOrQuery),
  }
}
