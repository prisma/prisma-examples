...
type DirectiveRoot struct {
	IsRole func(ctx context.Context, obj interface{}, next graphql.Resolver, role Role) (res interface{}, err error)
...
type MutationResolver interface {
	...
	Signup(ctx context.Context, username string, email string, password string) (AuthPayload, error)
...
func dir_isRole_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
	args := map[string]interface{}{}
	var arg0 Role
...
func (ec *executionContext) _Mutation_signup(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().Signup(rctx, args["username"].(string), args["email"].(string), args["password"].(string))
	})
	if resTmp == nil {
		if !ec.HasError(rctx) {
			ec.Errorf(ctx, "must not be null")
...
func (ec *executionContext) FieldMiddleware(ctx context.Context, obj interface{}, next graphql.Resolver) (ret interface{}) {
	...
	for _, d := range rctx.Field.Definition.Directives {
		switch d.Name {
		case "isRole":
			if ec.directives.IsRole != nil {
				rawArgs := d.ArgumentMap(ec.Variables)
				args, err := dir_isRole_args(rawArgs)
				if err != nil {
					ec.Error(ctx, err)
					return nil
				}
				...
				next = func(ctx context.Context) (interface{}, error) {
					return ec.directives.IsRole(ctx, obj, n, args["role"].(Role))
				}
			}
		case "private":
			if ec.directives.Private != nil {
				n := next
				next = func(ctx context.Context) (interface{}, error) {
					return ec.directives.Private(ctx, obj, n)
				}
			}
		}
	}
