...
export interface DelegateQuery {
  cat: <T: Promise<$Shape<CatNode | null>>>(
    where: CatWhereUniqueInput,
    fragment?: string | Object
  ) => T;
  cats: <T: Promise<Array<CatNode>>>(
  ...
  catsConnection: <T: Promise<$Shape<CatConnectionNode>>>(
    args?: {
      where?: CatWhereInput,
      orderBy?: CatOrderByInput,
      skip?: Int,
  ...
  master: <T: Promise<$Shape<MasterNode | null>>>(
    where: MasterWhereUniqueInput,
    fragment?: string | Object
  ) => T;
  masters: <T: Promise<Array<MasterNode>>>(
  ...
  mastersConnection: <T: Promise<$Shape<MasterConnectionNode>>>(
    args?: {
      where?: MasterWhereInput,
      orderBy?: MasterOrderByInput,
      skip?: Int,
...
export interface DelegateMutation {
  createCat: <T: Promise<$Shape<CatNode>>>(
    where: CatCreateInput,
    fragment?: string | Object
  ) => T;
  updateCat: <T: Promise<$Shape<CatNode | null>>>(
    args: { data: CatUpdateInput, where: CatWhereUniqueInput },
    info?: GraphQLResolveInfo,
    options?: Options
  ) => T;
  updateManyCats: <T: Promise<$Shape<BatchPayloadNode>>>(
    args: { data: CatUpdateInput, where?: CatWhereInput },
    info?: GraphQLResolveInfo,
    options?: Options
  ) => T;
  upsertCat: <T: Promise<$Shape<CatNode>>>(
    args: {
      where: CatWhereUniqueInput,
      create: CatCreateInput,
      update: CatUpdateInput
  ...
  deleteCat: <T: Promise<$Shape<CatNode | null>>>(
    where: CatWhereUniqueInput,
    fragment?: string | Object
  ) => T;
  deleteManyCats: <T: Promise<$Shape<BatchPayloadNode>>>(
    where?: CatWhereInput,
    fragment?: string | Object
  ) => T;
  createMaster: <T: Promise<$Shape<MasterNode>>>(
    where: MasterCreateInput,
    fragment?: string | Object
  ) => T;
  updateMaster: <T: Promise<$Shape<MasterNode | null>>>(
    args: { data: MasterUpdateInput, where: MasterWhereUniqueInput },
    info?: GraphQLResolveInfo,
    options?: Options
  ) => T;
  updateManyMasters: <T: Promise<$Shape<BatchPayloadNode>>>(
    args: { data: MasterUpdateInput, where?: MasterWhereInput },
    info?: GraphQLResolveInfo,
    options?: Options
  ) => T;
  upsertMaster: <T: Promise<$Shape<MasterNode>>>(
    args: {
      where: MasterWhereUniqueInput,
      create: MasterCreateInput,
      update: MasterUpdateInput
  ...
  deleteMaster: <T: Promise<$Shape<MasterNode | null>>>(
    where: MasterWhereUniqueInput,
    fragment?: string | Object
  ) => T;
  deleteManyMasters: <T: Promise<$Shape<BatchPayloadNode>>>(
    where?: MasterWhereInput,
    fragment?: string | Object
  ) => T;
}
...
export interface DelegateSubscription {
  cat: <T: Promise<AsyncIterator<$Shape<CatSubscriptionPayloadNode | null>>>>(
    where?: CatSubscriptionWhereInput,
    fragment?: string | Object
  ) => T;
  master: <
    T: Promise<AsyncIterator<$Shape<MasterSubscriptionPayloadNode | null>>>
  >(
    where?: MasterSubscriptionWhereInput,
    fragment?: string | Object
  ) => T;
