# GraphQL Server Example with `fastify-graphql` & Prisma Postgres (SDL-first)
...
```
npx try-prisma@latest --template orm/fastify-graphql-sdl-first --install npm --name fastify-graphql-sdl-first
```
