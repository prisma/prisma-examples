...
This example shows how to implement a simple web app using [SolidStart](https://start.solidjs.com) and [Prisma ORM](https://www.prisma.io/docs).
...
```
cd prisma-examples/orm/solid-start
npm install
```
...
### 3. Start the SolidStart server

```
npm run dev
```

The server is now running at http://localhost:3000. You can now view your todo list!
