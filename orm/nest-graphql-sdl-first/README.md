# GraphQL Server Example with NestJS (SDL-first) & Prisma Postgres
...
```
npx try-prisma@latest --template orm/nest-graphql-sdl-first --install npm --name nest-graphql-sdl-first
```
