# GraphQL Server CRUD Example with TypeGraphQL & Prisma Postgres

This example shows how to **implement a GraphQL server with TypeScript** using Prisma ORM, [apollo-server](https://www.apollographql.com/docs/apollo-server) and a [Prisma Postgres](https://www.prisma.io/postgres) database.
