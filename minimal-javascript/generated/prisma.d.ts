...
export interface Query     masters: (args?: { where?: MasterWhereInput, orderBy?: MasterOrderByInput, skip?: Int, after?: String, before?: String, first?: Int, last?: Int }) => Promise<Array<MasterNode>>;
...
export interface Mutation     createMaster: (data: MasterCreateInput) => Master;
...
export interface Subscription     master: <T = Promise<Partial<MasterSubscriptionPayloadNode | null>>>(where?: MasterSubscriptionWhereInput) => Promise<AsyncIterator<T>>;
    cat: <T = Promise<Partial<CatSubscriptionPayloadNode | null>>>(where?: CatSubscriptionWhereInput) => Promise<AsyncIterator<T>>

export interface Exists   master: (where?: MasterWhereInput) => Promise<boolean>
...
export interface DelegateQuery     masters: <T = Promise<Array<MasterNode>>>(args?: { where?: MasterWhereInput, orderBy?: MasterOrderByInput, skip?: Int, after?: String, before?: String, first?: Int, last?: Int , info?: GraphQLResolveInfo, options?: Options}) => T;
...
export interface DelegateMutation     createMaster: <T = Promise<Partial<MasterNode>>>(where: MasterCreateInput) => T;
