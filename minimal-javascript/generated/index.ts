...
export interface AtLeastOne<MasterWhereUniqueInput {
  id?: ID_Input
}>
...
export interface AtLeastOne<CatWhereUniqueInput {
  id?: ID_Input
}>
...
export const Prisma = makePrismaBindingClass<BindingConstructor<Prisma>>({typeDefs, endpoint: 'http://localhost:4466/prisma/dev'})
