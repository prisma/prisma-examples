...
export interface DelegateMutation {
    createHouse: <T = Promise<Partial<HouseNode>>>(where: HouseCreateInput) => T;
...
export interface AtLeastOne<HouseWhereUniqueInput {
  id?: ID_Input
}>
...
export interface AtLeastOne<WindowWhereUniqueInput {
  id?: ID_Input
}>
...
export const Prisma = makePrismaBindingClass<BindingConstructor<Prisma>>({typeDefs, endpoint: 'http://localhost:4466/house/dev'})
