...
// Code generated by Prisma (prisma@1.17.0-beta.36). DO NOT EDIT.
...
export interface User extends Promise<UserNode>, Fragmentable {
  ...
  name: () => Promise<String>;
  email: () => Promise<String>;
  posts: <T: Promise<Array<PostNode>>>(args?: {
    where?: PostWhereInput,
    orderBy?: PostOrderByInput,
    skip?: Int,
    after?: String,
...
export interface UserSubscription
  ...
  name: () => Promise<AsyncIterator<String>>;
  email: () => Promise<AsyncIterator<String>>;
  posts: <T: Promise<AsyncIterator<Array<PostSubscription>>>>(args?: {
    where?: PostWhereInput,
    orderBy?: PostOrderByInput,
    skip?: Int,
    after?: String,
...
export const Prisma = makePrismaClientClass<ClientConstructor<PrismaInterface>>(
  { typeDefs, endpoint: 'http://localhost:4466/flow-graphql/dev' },
)
