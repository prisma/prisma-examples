...
This is a Next.js App Router app that uses Prisma 8 with PostgreSQL. Prisma
Composer provisions its database and service, applies its schema, and deploys
it to Prisma Compute.
